...
def main() -> int:
    parser = argparse.ArgumentParser(description="Send a 3-second random audio file to device via voice talk")
    ...
    parser.add_argument("--duration", type=int, default=3, help="random audio duration in seconds")
