...
def main() -> int:
    ...
    output_dir = Path(args.output_dir) if args.output_dir else Path.cwd() / "recordings" / "discrete_frequency_audio" / host_dir
    output_path = output_dir / f"discrete_frequency_{host_dir}_{timestamp}.wav"
    ...
    print(f"discrete frequency audio ready: {output_path}")
